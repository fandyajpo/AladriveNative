...
import { Whatsapp, Sms, Telephone, InfoIcon } from "../../lib/listSvg";
        ...
        >
          ...
          <View style={tw`ml-2`}>
            <Text style={tw`text-sm text-gray-800`}>
              Kami akan mengirimkan form reset Pin setelah proses OTP.
            </Text>
          </View>
        </Pressable>
        <Pressable
          onPress={() => PushRoute(componentId, "MasukkanPinOtp")}
          style={tw`border border-gray-200 w-full rounded-md my-1 flex-row items-center p-2 shadow-sm bg-white`}
        >
          <Whatsapp />
          <View style={tw`ml-3`}>
