...
import { Location, Market, AddPartner } from "../../lib/listSvg";
...
const Item = ({ status, name, location, tag, perKm, componentId }) => {
  const goToOutlet = React.useCallback(() => {
    PushRoute(componentId, "OutletProfile");
  }, []);
  return (
    <Pressable
      onPress={goToOutlet}
  ...
  return (
    ...
    >
      <FlatList
        ...
        contentContainerStyle={tw`pb-24 pt-14 sm:pt-16 px-2`}
        data={DATA}
