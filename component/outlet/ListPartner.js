...
const Item = ({ name, location, tag, perKm, componentId }) => {
  const goToOutlet = React.useCallback(() => {
    PushRoute(componentId, "PartnerProfile");
  }, []);
  return (
    <Pressable
      onPress={goToOutlet}
  ...
  return (
    ...
    >
      <FlatList
        ...
        contentContainerStyle={tw`pb-20 pt-14 sm:pt-16 px-2`}
        data={DATA}
